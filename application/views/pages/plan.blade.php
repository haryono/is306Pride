      ...
      <li data-theme="d">
        ...
        <div class="ui-grid-a">
          ...
          <div class="ui-block-b">
            <a href="{{URL::to('learnmore/'.$enrolled->courseid);}}" data-mini="true" data-transition="slide" data-role="button" data-icon="arrow-r" data-theme="e" data-iconpos="right" >Learn more</a>
          </div>
     ...
     <?php $avgprice = DB::query('select avg(`bidprice`) as `avgprice` from `plans` where `course_id` = ?',array($notenrolled->courseid));?>
      <li data-theme="d">
        ...
        <div class="ui-grid-a">
          ...
          <div class="ui-block-b">
            <a href="{{URL::to('learnmore/'.$notenrolled->courseid);}}" data-mini="true" data-transition="slide" data-role="button" data-icon="arrow-r" data-theme="e" data-iconpos="right" >Learn more</a>
          </div>
        </div>
        <center><h4 style="white-space:normal">Team</h4></center>
